...
- [ ] Add/edit the super stack/our create expo stack fork to use SDK 56
- [ ] GO through generated app info pages and fix any references that mismatch expo sdk 56.
- [ ] Fix presentation view for modal on web after 56 update to be like a mobile modal instead of a full screen page.
- [ ] Use expo ui, native tabs, and other newly stable packages from expo in the generated app and exposition pages. Create and exposition page for expo sdk 56 including an inline expo module! add it to all layout generations.
- [ ] Ensure that create expo super stack is actually using the layout choice chosen during create expo stack. 
