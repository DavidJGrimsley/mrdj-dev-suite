...
Roadmap reference: `project/todo.md:97`
Branch: `docs/app-store-connect-guidance`
Base commit: `43c7906a2731de597b4a902183c19404ce1362a7`

## Goal

Expand generated App Store Connect guidance with prerequisites, credentials, TestFlight, production submission, and troubleshooting.

## Boundaries

- Work only in this worktree: `F:\\SoftwareDev\\mrdj-dev-suite-i2Workspace\\mrdj-dev-suite-app-store-connect-guidance`.
...
Recommended worker: Tier 2 — GPT-5.6-luna, low-medium reasoning — documentation and generated-content task.
