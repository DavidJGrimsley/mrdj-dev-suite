...
Roadmap reference: `project/todo.md:84`
Branch: `fix/dogfood-seo`
Base commit: `43c7906a2731de597b4a902183c19404ce1362a7`

## Goal

Dogfood the SEO workflow against pre-MDS DJsPortfolio; verify server-visible data-loader/API/MCP pages and JSON-LD, then extend SEO knowledge/checks only for evidenced gaps.

## Boundaries

- Work only in this worktree: `F:\\SoftwareDev\\mrdj-dev-suite-i2Workspace\\mrdj-dev-suite-dogfood-seo`.
...
Recommended worker: Tier 3 — GPT-5.6-sol, medium reasoning — multi-surface SEO validation and scoped knowledge updates.
