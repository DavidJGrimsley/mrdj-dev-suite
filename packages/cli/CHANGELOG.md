...
- 442a75c: Add credential-gated EAS workflows for iOS TestFlight and App Store Connect uploads.
- 87f4333: Generate canonical release metadata and platform-aware app-store release tasks for new projects.
