---
name: "MDS Github Setup Guidance"
description: "Use when the user asks Mr. DJ's Dev Suite to inspect authenticated GitHub setup, CI workflows, pull requests, or branch rulesets and provide exact safe procedures."
---
