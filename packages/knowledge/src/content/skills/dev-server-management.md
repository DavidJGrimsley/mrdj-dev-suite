...
- If a conflict remains, run `mrdj kill-port <port...>` for blocked ports.
...
- Fix: Run `mrdj clear-expo-start`, kill remaining blocked ports, clear cache, and restart via the project’s clean-start script.
